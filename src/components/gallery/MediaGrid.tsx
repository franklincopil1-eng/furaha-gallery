...
import { Search, X, MapPin, Play, Film, Image as ImageIcon } from 'lucide-react';
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between">
                    ...
                    {item.location && (
                      <div className="flex items-center justify-between mt-3 pt-2.5 border-t border-[#ebdcd0]/60 text-[14px] text-[#717275] font-light">
