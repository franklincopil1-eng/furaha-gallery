  ...
  const mediaItems = [
    {
      ...
      location: 'Kenya',
      image: '/Education.jpg',
      caption: 'Educational support, learning materials, and study sessions with children in Kenya.',
    },
    {
      id: 2,
    ...
    {
      id: 3,
      title: 'Clothing & Care Packages',
      category: 'Outreach',
      location: 'Kenya',
      image: '/volunteer-selecting-organizing-clothes-donations-charity.jpg',
      caption: 'Sorting clothing items and basic essentials for community outreach and child support.',
    },
    {
      id: 4,
      ...
      caption: 'Staff and community leaders gathered together in prayer and thanksgiving for children in Kenya.',
    },
  ];
