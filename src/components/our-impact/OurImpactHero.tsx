...
interface OurImpactHeroProps {
  onNavigateToHome?: () => void;
  onExploreLatestClick?: () => void;
  onGiveClick?: () => void;
}

export const OurImpactHero: React.FC<OurImpactHeroProps> = ({
  onNavigateToHome,
  onExploreLatestClick,
  onGiveClick,
}) => {
  ...
  return (
    <section
      ref={containerRef}
      aria-label="Our Impact in Kenya"
    ...
    >
        ...
        >
          <picture className="w-full h-full block">
            ...
            <img
              ...
              alt="Community fellowship and children gathered in Kenya supported by Furaha Ministries"
              className="w-full h-full object-cover object-[center_35%] scale-[1.03] filter blur-[1px] sm:blur-[1.5px]"
              loading="eager"
              fetchPriority="high"
            />
          </picture>
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 flex items-center justify-between text-xs text-[#f7e4b7]/90 font-sans">
        <button
          type="button"
      ...
      {/* 3. Streamlined Centered Editorial Typography - Clean, Space-Saving & Curiosity-Driven */}
      <div className="relative z-10 max-w-2xl w-full mx-auto px-4 sm:px-6 my-auto py-3 sm:py-5 text-center font-sans">
        <motion.div
        ...
        >
          ...
          <motion.h1
            id="our-impact-headline"
            initial={{ opacity: 0, y: prefersReducedMotion ? 0 : 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1], delay: 0.1 }}
            className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white tracking-[-1px] sm:tracking-[-1.5px] leading-tight mb-2 drop-shadow-[0_2px_8px_rgba(0,0,0,0.85)] font-sans"
          >
          ...
          <motion.p
            id="our-impact-subheadline"
            initial={{ opacity: 0, y: prefersReducedMotion ? 0 : 14 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1], delay: 0.2 }}
            className="text-[#f7e4b7] text-xs sm:text-sm md:text-[15px] font-normal leading-relaxed max-w-lg mx-auto drop-shadow-[0_1px_4px_rgba(0,0,0,0.75)] mb-4 font-sans"
          >
            Documented field updates, measurable care, and lasting transformation across Kenya.
          </motion.p>
          ...
          >
            ...
            <button
              type="button"
              onClick={onExploreLatestClick}
              id="our-impact-explore-cta"
            ...
            >
              <span>Explore Field Journal</span>
      ...
      <div className="relative z-10 h-4 sm:h-6" aria-hidden="true" />
    </section>
  );
};
