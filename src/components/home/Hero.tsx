...
export const Hero: React.FC<HeroProps> = ({ onOpenDonateModal }) => {
  ...
  const slides: SlideData[] = [
    {
      url: '/images/volunteer-selecting-organizing-clothes-donations-charity.jpg',
      webpUrl: '/images/volunteer-selecting-organizing-clothes-donations-charity.webp',
    ...
    },
    {
      ...
      webpUrl: '/images/volunteer-helping-with-donation-box1.webp',
